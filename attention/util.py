...
class ConvCorpus:
    ...
    def _construct_dict(self, file_path, batch_size, size_filter):
        ...
        self.dic.filter_extremes(no_below=1, no_above=1.0, keep_n=100000)
        print(len(self.dic))
        # add symbols
...
class JaConvCorpus:
    ...
    def _construct_dict(self, file_path, batch_size, size_filter):
        ...
        # construct dictionary
        self.dic = corpora.Dictionary(posts + cmnts, prune_at=None)
        self.dic.filter_extremes(no_below=2, no_above=1.0, keep_n=100000)    # remove low frequency words
