...
parser.add_argument('--feature_num', '-f', default=512, type=int, help='dimension of feature layer')
    ...
    while True:
        ...
        if args.lang == 'en':
            ...
            if len(input_vocab) == 0:
                ...
                del input_vocab[-1]
                input_vocab.append('__label__2')
            elif input_vocab[-1] == '0':
                del input_vocab[-1]
                input_vocab.append('__label__0')
            elif input_vocab[-1] == '1':
                del input_vocab[-1]
                input_vocab.append('__label__1')
            else:
